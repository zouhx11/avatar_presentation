...
// Set your password here (you can change this)
const CORRECT_PASSWORD = 'AvatarWorkshop2024'

onMounted(() => {
  // Check if already authenticated in this session
  const storedAuth = sessionStorage.getItem('slidev-auth')
...
function checkPassword() {
  if (password.value === CORRECT_PASSWORD) {
    isAuthenticated.value = true
    sessionStorage.setItem('slidev-auth', 'authenticated')
...
<template>
  <div v-if="!isAuthenticated" class="password-overlay">
    <div class="password-form">
      <h2 style="color: #333; margin-bottom: 1rem;">🎓 AI Avatar Workshop</h2>
      <p style="color: #666; margin-bottom: 1.5rem;">Please enter the password to access the slides</p>
      <input 
        v-model="password" 
        type="password" 
      ...
      <p v-if="showError" style="color: #e74c3c; margin-top: 1rem; font-size: 14px;">
        ❌ Incorrect password. Please try again.
      </p>
      <p style="color: #888; font-size: 12px; margin-top: 1rem;">
        Contact the instructor if you need access
      </p>
    </div>
  </div>
</template>
